export function calculateAlignment () {
	const [before, after, crossBefore1, crossAfter1, crossBefore2, crossAfter2, farBefore, farAfter] = arguments;
...
export function getDepths () {
	const [points, map, y, x, yChange, xChange, offset] = arguments;
...
export function getNormal () {
	const [vertexes, map, y, x, offset] = arguments;
...
export function getFiller () {
	const [vertexes, map, y, x] = arguments;
